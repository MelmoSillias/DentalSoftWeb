...
use App\ClinicalRecord\Repository\FicheObservationRepository;
...
class FicheObservation
{
    ...
    private function generateDefaultToothsCheck() : array
    {
        ...
        // Dentition permanente (11 à 18 et 21 à 28 et 31 à 38 et 41 à 48)
        // Haut droite (11 à 18)
        for ($i = 11; $i <= 18; $i++) {
            $tooths[(string)$i] = '';
        }
        ...
        // Dentition temporaire (51 à 55 et 61 à 65 et 71 à 75 et 81 à 85)
        // Haut droite (51 à 55)
        for ($i = 51; $i <= 55; $i++) {
            $tooths[(string)$i] = '';
        }
