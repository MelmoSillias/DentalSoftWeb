...
use App\ClinicalRecord\Infrastructure\Persistence\Doctrine\Repository\FicheMedicaleRepository;
...
class FicheMedicale
{
    ...
    public function addDevis(Devis $devis): static
    {
        if (!$this->devis->contains($devis)) {
            $this->devis[] = $devis;
            /** @var \App\ClinicalRecord\Infrastructure\Persistence\Doctrine\Entity\FicheMedicale $currentFicheMedicale */
