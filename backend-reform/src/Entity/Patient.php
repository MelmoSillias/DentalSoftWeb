...
class Patient
{
   ...
   /**
    ...
    public function addFicheMedicale(FicheMedicale $fiche): self
    {
        if (!$this->fichesMedicales->contains($fiche)) {
            $this->fichesMedicales[] = $fiche;
            $fiche->setPatient($this);
        }
    ...
    public function removeFicheMedicale(FicheMedicale $fiche): self
    {
        if ($this->fichesMedicales->removeElement($fiche)) {
            if ($fiche->getPatient() === $this) {
                $fiche->setPatient(null);
            }
        }
