...
class Consommable
{
    ...
    public function getLowValue(): ?int { return $this->lowValue; }
    public function setLowValue(int $lowValue): static { $this->lowValue = $lowValue; return $this; }
    ...
    {
        if ($this->stocks->removeElement($stock) && $stock->getConsommable() === $this) {
