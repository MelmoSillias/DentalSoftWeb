...
namespace App\Patient\Infrastructure\Persistence\Doctrine\Entity;

use App\Patient\Infrastructure\Persistence\Doctrine\Repository\ContactUrgenceRepository;
...
class ContactUrgence
{
    ...
    #[ORM\OneToOne(inversedBy: 'contactUrgence', targetEntity: Patient::class)]
