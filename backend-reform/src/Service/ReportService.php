...
class ReportService
{
    ...
    public function getReportsData(?string $period, ?string $customStart, ?string $customEnd, ?string $employeeId): array
    {
        ...
        $revenueTrend = [
            ['date' => $startDate->format('Y-m-d'), 'amount' => 40000],
            ['date' => $endDate->format('Y-m-d'), 'amount' => 50000],
        ];
        ...
        $appointmentsTrend = [
            ['date' => $startDate->format('Y-m-d'), 'appointments' => 10, 'consultations' => 8],
            ['date' => $endDate->format('Y-m-d'), 'appointments' => 12, 'consultations' => 9],
        ];
