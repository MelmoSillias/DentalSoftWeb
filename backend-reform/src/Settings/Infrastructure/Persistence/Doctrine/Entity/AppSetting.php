...
namespace App\Settings\Infrastructure\Persistence\Doctrine\Entity;
...
class AppSetting
{
    ...
    public function setValue(array $value): static { $this->value = $value; $this->updatedAt = new \DateTimeImmutable(); return $this; }
