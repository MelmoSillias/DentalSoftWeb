...
function loadGlobalStats(from, to) {
  $.getJSON('/api/report/global-stats', { from, to }, data => {
...
function loadNonPeriodicDetails() {
    $.getJSON('/api/report/nonperiodic/employees-distribution', function(data) {
...
function loadLowStockConsumables() {
  $.getJSON('/api/report/nonperiodic/low-stock-consumables', items => {
...
function loadGlobalPatientsDetails() {
  $.getJSON('/api/report/global/patients', s => { 
...
function loadPeriodicPatients(from, to) {
  $.getJSON('/api/report/periodic/patients', { from, to })
    .done(data => {
      // Nouveaux patients
...
function loadPeriodicConsultations(from, to) {
  $.getJSON('/api/report/periodic/consultations', { from, to }, s => {
...
function loadPeriodicAppointments(from, to) {
  $.getJSON('/api/report/periodic/appointments', { from, to }, s => {
...
function loadPeriodicRoomUsage(from, to) {
  $.getJSON('/api/report/periodic/room-usage', { from, to }, data => {
...
function loadPeriodicPaymentBalances(from, to) {
  $.getJSON('/api/report/periodic/payment-balances', { from, to })
    .done(modes => {
...
function loadPeriodicPaymentFrequency(from, to) {
  $.getJSON('/api/report/periodic/payment-frequency', { from, to })
    .done(data => {
...
function loadActsStats(from, to) {
  $.getJSON('/api/report/periodic/acts-stats', { from, to }, acts => {
...
function loadDoctorReports(from, to) {
  $.getJSON('/api/report/periodic/doctor-reports', { from, to }, resp => {
    // Affichage des KPI
