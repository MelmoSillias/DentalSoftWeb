import{H as t,J as n,o,c as p,a6 as i,X as s}from"./index-kCrd55C3.js";var r=({dt:l})=>`
.p-floatlabel {
    display: block;
    position: relative;
}
...
`,b={root:function(e){var a=e.props;return["p-floatlabel",{"p-floatlabel-over":a.variant==="over","p-floatlabel-on":a.variant==="on","p-floatlabel-in":a.variant==="in"}]}},f=t.extend({name:"floatlabel",style:r,classes:b}),c={name:"BaseFloatLabel",extends:n,props:{variant:{type:String,default:"over"}},style:f,provide:function(){return{$pcFloatLabel:this,$parentInstance:this}}},u={name:"FloatLabel",extends:c,inheritAttrs:!1};function d(l,e,a,h,$,v){return o(),p("span",s({class:l.cx("root")},l.ptmi("root")),[i(l.$slots,"default")],16)}u.render=d;export{u as s};
