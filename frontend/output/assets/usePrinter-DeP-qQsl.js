import{r as m,b1 as f,ab as h,ag as w}from"./index-Cek4WNxD.js";const E="/assets/header-big-PYnGij3P.jpeg",b=(r,n)=>{Array.from(r.querySelectorAll('style, link[rel="stylesheet"]')).forEach(u=>{const o=u.cloneNode(!0);n.head.appendChild(o)})},v=r=>{const n=r.createElement("style");n.type="text/css",n.textContent=`
        html, body {
