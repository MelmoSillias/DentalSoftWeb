...
const emit = defineEmits(['back', 'refresh', 'create-lot', 'update-lot', 'view-lot', 'send-lot', 'reopen-lot', 'confirm-lot', 'unconfirm-lot', 'refund-lot', 'view-claim', 'pay-claim', 'modify-claim', 'assign-claim', 'change-claim-lot']);
