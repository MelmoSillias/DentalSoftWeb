    ...
    <div class="flex flex-col h-full rounded-2xl border border-surface-200 dark:border-surface-700 bg-surface-0 dark:bg-surface-900 shadow-xl overflow-hidden">
        ...
        <div class="p-4 border-t border-surface-200 dark:border-surface-700">
            <Button
                ...
                outlined
                as="router-link"
                :to="['/agenda/rendez-vous', '/consultations/cards', '/caisse', isReception ? '/caisse' : isMedecin ? '/consultations/table' : '/agenda/rendez-vous', isMedecin ? '/consultations/table' : ''][activeIndex]"
            />
        </div>
    </div>
</template>
