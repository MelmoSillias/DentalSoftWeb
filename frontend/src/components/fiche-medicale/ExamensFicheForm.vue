...
const updateExamenLabo = (idx, key, value) => {
    examensLaboRows.value = examensLaboRows.value.map((item, i) =>
        i === idx ? { ...item, [key]: value } : item
    );
};

const exoInspectionList = [
    'Asymetrie',
    'Coloration',
    'Fistule',
    'Autres (a preciser)',
            ...
            <TabPanels class="mt-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            <p class="text-sm text-surface-600 dark:text-surface-300">
                                Renseignez les examens personnalisés de laboratoire.
                            </p>
                            <Button
                                label="Ajouter"
                                icon="pi pi-plus"
                        ...
                        <div
                            v-if="!examensLaboRows.length"
                            class="text-sm text-surface-500 dark:text-surface-400 border border-dashed border-surface-300 dark:border-surface-600 rounded-xl p-4">
                            Aucun examen complémentaire ajouté.
                        </div>

                        <div v-else class="space-y-3">
                            <div
                                v-for="(item, idx) in examensLaboRows"
                                :key="idx"
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-3">
                                    <div class="lg:col-span-2 space-y-1">
                                        ...
                                        <InputText
                                            ...
                                            class="w-full"
                                            @update:modelValue="(v) => updateExamenLabo(idx, 'type', v)" />
                                    </div>
                                    ...
                                    <div class="lg:col-span-4 space-y-1">
                                        ...
                                        <InputText
                                            ...
                                            class="w-full"
                                            @update:modelValue="(v) => updateExamenLabo(idx, 'description', v)" />
                                    </div>
                                    ...
                                    <div class="lg:col-span-2 space-y-1">
                                        ...
                                        <DatePicker
                                            ...
                                            showIcon
                                            class="w-full"
                                            @update:modelValue="(v) => updateExamenLabo(idx, 'date', v)" />
                                    </div>

                                    <div class="lg:col-span-3 space-y-1">
                                        <label class="text-xs text-surface-500">Résultat</label>
                                        <InputText
                                            :modelValue="item.resultat"
                                            class="w-full"
                                            @update:modelValue="(v) => updateExamenLabo(idx, 'resultat', v)" />
                                    </div>
                        ...
                        <div class="space-y-2 pt-2">
                            ...
                            <Textarea
                                :modelValue="form.diagnosticSupposeExamens"
                                rows="4"
                                class="w-full"
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div
                                ...
                                <div class="space-y-2 grid lg:grid-cols-2 sm:grid-cols-1 gap-3">
                                    <div
                                        v-for="label in exoInspectionList"
                                        :key="label"
                                        ...
                                        <Textarea
                                            :modelValue="getMapValue('exobuccalInspection', label)"
                                            placeholder="Details"
                                            rows="4"
                                            class="w-full h-auto"
                            ...
                            <div
                                ...
                                <div class="space-y-2 grid grid-cols-2 sm:grid-cols-1 gap-3">
                                    <div
                                        v-for="label in exoPalpationList"
                                        :key="label"
                                        class="flex flex-col gap-2 p-3 rounded-lg bg-surface-0 dark:bg-surface-800">
                                        <span class="text-sm font-medium text-surface-700 dark:text-surface-300">{{ label }}</span>
                                        <Textarea
                                            :modelValue="getMapValue('exobuccalPalpation', label)"
                                            placeholder="Details"
                                            class="w-full"
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div
                                    v-for="label in chainesList"
                                    :key="label"
                                    class="flex items-center gap-2 p-3 rounded-lg bg-surface-0 dark:bg-surface-800">
                                    <Checkbox
                                        :modelValue="Boolean(form?.chainesGanglionnaires?.[label])"
                                        binary
                ...
                <TabPanel value="endobuccal">
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <Textarea
                                        :modelValue="form.endobuccalBoucheFermee?.occlusion"
                                        rows="3"
                                        class="w-full"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <InputText
                                        :modelValue="form.endobuccalBoucheFermee?.mediane"
                                        class="w-full"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <InputText
                                        :modelValue="form.endobuccalBoucheFermee?.classesAngle"
                                        class="w-full"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <InputText
                                        :modelValue="form.endobuccalBoucheFermee?.vestibules"
                                        class="w-full"
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <InputText
                                        :modelValue="form.endobuccalBoucheOuverte?.hbd"
                                        class="w-full"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <InputText
                                        :modelValue="form.endobuccalBoucheOuverte?.brossage"
                                        class="w-full"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <InputText
                                        :modelValue="form.endobuccalBoucheOuverte?.soccu"
                                        class="w-full"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <InputText
                                        :modelValue="form.endobuccalBoucheOuverte?.cinematiqueMandibulaire"
                                        class="w-full"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <InputText
                                        :modelValue="form.endobuccalBoucheOuverte?.ouvertureBuccale"
                                        class="w-full"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <InputText
                                        :modelValue="form.endobuccalBoucheOuverte?.temperatureBuccale"
                                        class="w-full"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <InputText
                                        :modelValue="form.endobuccalBoucheOuverte?.amplitudeOuverture"
                                        class="w-full"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <InputText
                                        :modelValue="form.endobuccalBoucheOuverte?.bruitsArticulaires"
                                        class="w-full"
                        ...
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-surface-700 dark:text-surface-300">
                                Examen des canaux excreteurs
                            </label>
                            <Textarea
                                :modelValue="form.examenCanauxExcreteurs"
                                rows="3"
                                class="w-full"
                            ...
                            <table class="w-full text-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th
                                            v-for="col in tissusMousColumns"
                                            :key="col"
                                ...
                                <tbody>
                                    <tr
                                        ...
                                        <td v-for="col in tissusMousColumns" :key="col" class="p-2">
                                            <InputText
                                                :modelValue="getTableValue('tissusMousTable', row, col)"
                                                class="w-full"
                            ...
                            <table class="w-full text-sm">
                                <thead>
                                    <tr>
                                        <th class="p-2 text-left"></th>
                                        <th
                                            v-for="col in tissusDursColumns"
                                            :key="col"
                                            class="p-2 text-left font-semibold text-surface-700 dark:text-surface-300">
                                            {{ col }}
                                        </th>
                                ...
                                <tbody>
                                    <tr
                                        v-for="row in tissusDursRows"
                                        :key="row"
                                        class="border-t border-surface-200 dark:border-surface-700">
                                        <td class="p-2 font-semibold text-surface-700 dark:text-surface-300">{{ row }}</td>
                                        <td v-for="col in tissusDursColumns" :key="col" class="p-2">
                                            <InputText
                                                :modelValue="getTableValue('tissusDursTable', row, col)"
                                                class="w-full"
                ...
                <TabPanel value="examens-biologiques">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            ...
                            <InputText
                                :modelValue="form.examensBacteriologiques?.observation"
                                placeholder="Observation"
                                class="w-full"
                                @update:modelValue="(v) => updateNested('examensBacteriologiques', 'observation', v)" />
                            <InputText
                                :modelValue="form.examensBacteriologiques?.resultat"
                        ...
                        <div class="space-y-2">
                            ...
                            <InputText
                                :modelValue="form.examensSerologiques?.observation"
                                placeholder="Observation"
                                class="w-full"
                                @update:modelValue="(v) => updateNested('examensSerologiques', 'observation', v)" />
                            <InputText
                                :modelValue="form.examensSerologiques?.resultat"
                                placeholder="Resultat"
                                class="w-full"
                        ...
                        <div class="space-y-2">
                            ...
                            <InputText
                                :modelValue="form.examensHistologiques?.observation"
                                placeholder="Observation"
                                class="w-full"
                                @update:modelValue="(v) => updateNested('examensHistologiques', 'observation', v)" />
                            <InputText
                                :modelValue="form.examensHistologiques?.resultat"
                                placeholder="Resultat"
                                class="w-full"
