...
<template>
    ...
    >
        <template #header>
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-sm text-surface-500 dark:text-surface-400 mt-0.5">Dossier complet — affichage en onglets</p>
                </div>
            </div>
        </template>
        ...
        >
            ...
            <FormPatient ref="patientEditFormRef" :patient="patient" class="mt-2" @saved="handlePatientSaved" @cancel="showEditDialog = false" />
        </Dialog>
