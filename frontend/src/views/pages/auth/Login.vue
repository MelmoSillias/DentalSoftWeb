                ...
                <div class="w-full rounded-3xl shadow-2xl overflow-hidden bg-surface-0 dark:bg-surface-900 border border-surface-200 dark:border-surface-700">
                    ...
                    <div class="p-6 md:p-8">
                        <div class="text-center mb-6">
                            <div class="text-surface-900 dark:text-surface-0 text-2xl font-semibold mb-2">Bienvenue sur Dentalsoft! <br> <small class="text-sm text-surface-600 dark:text-surface-400">Cabinet Dentaire Orodent</small></div>
